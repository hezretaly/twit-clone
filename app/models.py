...
# While Elasticsearch is not running commenting listens
...
class User(UserMixin, db.Model):
    ...
    avatar_img = db.Column(db.String(64), unique=True)
...
# Implement a Post Photos if you have enough time
